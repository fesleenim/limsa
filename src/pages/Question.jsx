        ...
        <div className="max-w-[1420px] mx-auto ">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div  className='flex justify-between md:w-[45%] w-[90%]  mt-[150px]'>
              <img className=' w-[48%] h-[450px]' src={ImgBoy} alt="" />
              <img className=' w-[49%] h-[470px] mt-10' src={ImgGirl} alt="" />
            </div>
            <div id="accordion-collapse" data-accordion="collapse" className=' md:w-[45%] w-[90%]'>
              <h1 className='text-5xl font-medium text-white mb-10'>Часто задаваемые вопросы</h1>
          ...
          <Marquee  direction="right" speed={200}>
            <div className="mt-30 md:flex hidden gap-[50px] " >
              <strong className='text-3xl text-white'>УСЛУГА ПО СОЗДАНИЮ ВЕБ-САЙТОВ</strong>
              <p className='text-xl text-white'>/</p>
              <strong className='text-3xl text-white'> МОБИЛЬНЫЕ ПРИЛОЖЕНИЯ</strong>
              <p className='text-xl text-white'>/</p>
              <strong className='text-3xl text-white'>СИСТЕМЫ АВТОМАТИЗАЦИИ</strong>
              <p className='text-xl text-white'>/</p>
              <strong className=' ml-[20px] text-3xl text-white'>ЦИФРОВЫЕ РЕШЕНИЯ</strong>
            </div>
          </Marquee>
        </div>
      </div>
