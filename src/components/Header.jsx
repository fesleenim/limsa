  ...
  return (
    <>
      <div className="dark:bg-gray-900">
        <nav
          className={`fixed ${
            scrolled ? "bg-black" : "dark:bg-gray-900"
        ...
        >
              ...
              <div className="md:flex items-center justify-between w-full md:w-auto md:order-1 ml-5 mt-2 hidden">
                <ul className="flex flex-col font-medium p-5 md:p-0 mt-10 border rounded-lg md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-3 md:border-0">
                  <li>
                    <a
                      href="/"
                      className="block py-2 px-3 md:p-0 text-white bg-[#6c2dba] rounded-sm md:bg-transparent md:text-[#6c2dba] md:dark:text-[#6c2dba]"
                      aria-current="page"
                    >
                      Главная
                    </a>
                  ...
                  <li>
                    <a
                      href="/service"
                      className="block py-2 px-3 md:p-0 text-gray-900 rounded-sm md:hover:bg-transparent md:hover:text-[#6c2dba] md:dark:hover:text-[#6c2dba] dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700"
                    >
                      Hаши услуги
                    </a>
                  </li>
          ...
          <div
            className={`md:hidden fixed top-0 right-0 bg-gray-800 bg-opacity-75 w-2/3 h-full transform ${
          ...
          >
            ...
            <ul className="flex flex-col p-5 space-y-6 mt-10">
              <li>
                <a
                  href="/"
                  className="block py-2 px-3 md:p-0 text-white bg-[#6c2dba] rounded-sm md:bg-transparent md:text-blue-700 md:dark:text-blue-500"
                  aria-current="page"
                >
                  главная
                </a>
